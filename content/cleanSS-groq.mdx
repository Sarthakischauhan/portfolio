...
<ul className="list-disc">
  <li>Detect screenshots on your desktop</li>
  <li>Analyze their content using AI</li>
  <li>Categorize them into appropriate folders</li>
  <li>Handle image compression when needed</li>
</ul>

<div className="mt-10 mb-4">
<h1 className="m-0 p-0">**Before and After**</h1>
</div>
